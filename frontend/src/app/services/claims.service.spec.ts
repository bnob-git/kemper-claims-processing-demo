...
import { Claim, Policy, AppUser, ClaimEvent, Assignment, DocumentMetadata, Payment } from '../models/claim.model';
...
describe('ClaimsService', () => {
  ...
  it('should auto-assign a claim', () => {
    ...
    req.flush({ id: 1, claimId: 1, assignmentType: 'AUTO' });
  });
  ...
  it('should manually assign a claim', () => {
    ...
    req.flush({ id: 1, claimId: 1, assignmentType: 'MANUAL' });
  });
  ...
  it('should approve reserve without amount', () => {
  ...
  it('should deny reserve', () => {
    ...
    const req = httpMock.expectOne(`${baseUrl}/claims/1/reserve-decision`);
    expect(req.request.method).toBe('POST');
    req.flush({ ...mockClaim, status: 'DENIED' });
  });
  ...
  it('should add a document', () => {
    const data = { fileName: 'test.pdf', documentType: 'PHOTO' };
  ...
  it('should issue a payment', () => {
    ...
    req.flush({ id: 1, claimId: 1, amount: 3000, status: 'COMPLETED' });
  });
  ...
  it('should close a claim without subrogation', () => {
    ...
    req.flush({ ...mockClaim, status: 'CLOSED', subrogationFlag: false });
  });
